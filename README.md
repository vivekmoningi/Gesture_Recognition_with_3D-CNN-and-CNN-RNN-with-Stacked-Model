...
Gesture Recognition as the name suggests is to control tv based on gestures.The gestures are continuously monitored by the webcam mounted on the TV. Each gesture corresponds to a specific command:
